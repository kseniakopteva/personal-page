...
export default function Tarot() {
	...
	return (
		<div
			className={clsx(
				"absolute w-[18%] top-[426px] text-sm",
				themeWindowClasses,
				themeTopBarClasses,
				themeBodyClasses,
			)}
		...
		>
			<div
				className={clsx(
					"text-white text-sm h-80 flex bg-[url('../../../public/img/patterns/stars.gif')] motion-reduce:bg-[url('../../../public/img/patterns/stars.jpg')]",
					status === "initial" ? "" : "",
				)}
			>
				{status === "initial" && (
					<div className="h-full flex-1 flex flex-col justify-center items-center">
						<img
							className="h-35 mb-2"
							src="/public/img/tarot/decor.png"
							alt=""
						/>
